...
| 04_calibration  | complete            | cam12/e1/v1 (approved)                                                 |
...
- **0 of 217 crops** (0.0%) fall below the native-resolution floor. No detector can answer for these.
- Median crop magnification **2.96x**, maximum **13.33x**. Magnification is interpolation, not detail.
- Crop policy mix: {'lap_bag_context': 71, 'native_source_context_fallback': 21, 'pose_hand_context': 125}.

- Crops fell back from `pose_hand_context` for: {'no_pose_observation': 69, 'wrist_confidence_below_floor': 23}.
