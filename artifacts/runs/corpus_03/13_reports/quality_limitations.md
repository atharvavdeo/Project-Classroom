# Quality limitations — run `corpus_03`

Every limitation below is measured from this run's artifacts.

## Source resolution

0 of 217 crops (0.0%) are below the native-resolution floor for an object call. These are abstentions by construction: no detector, slicing configuration or VLM can recover detail the source never captured.

Median magnification 2.96x, maximum 13.33x.
