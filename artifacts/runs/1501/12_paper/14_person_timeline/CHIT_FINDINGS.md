...
Source: `samples_with_chits.jsonl` in `artifacts\runs\1501\12_paper`.

**1817 raw detections -> 393 kept** after gating on confidence >= 0.4, size <= 0.12 of the person box, and within 0.35 person-widths of a resolved wrist.

Rejections, across all tracks:

- away from the hands: 729
- larger than a chit: 621
...
| 6 | 114 | brief_paper_handling | 1.8s | 1.5s | 2 | 0.67 |
