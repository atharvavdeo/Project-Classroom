# Final report — run `1446/01_phone`
...
- **7 of 1076 crops** (0.7%) fall below the native-resolution floor. No detector can answer for these.
- Median crop magnification **3.73x**, maximum **13.33x**. Magnification is interpolation, not detail.
- Crop policy mix: {'native_source_context_fallback': 315, 'pose_hand_context': 761}.

- Crops fell back from `pose_hand_context` for: {'no_pose_observation': 121, 'wrist_confidence_below_floor': 194}.
