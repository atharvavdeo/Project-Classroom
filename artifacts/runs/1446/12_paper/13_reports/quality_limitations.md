# Quality limitations — run `1446/12_paper`

Every limitation below is measured from this run's artifacts.

## Source resolution

233 of 5881 crops (4.0%) are below the native-resolution floor for an object call. These are abstentions by construction: no detector, slicing configuration or VLM can recover detail the source never captured.

Median magnification 7.34x, maximum 21.46x.
