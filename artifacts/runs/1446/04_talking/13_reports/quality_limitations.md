# Quality limitations — run `1446/04_talking`

Every limitation below is measured from this run's artifacts.

## Source resolution

164 of 3542 crops (4.6%) are below the native-resolution floor for an object call. These are abstentions by construction: no detector, slicing configuration or VLM can recover detail the source never captured.

Median magnification 5.28x, maximum 15.42x.
